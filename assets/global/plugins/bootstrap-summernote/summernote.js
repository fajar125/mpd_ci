...
(function (factory) {
  ...
  var Context = function ($note, options) {
    ...
    /**
     * create layout and initialize p_application and other resources
     */
    ...
    /**
     * destroy p_application and other resources and remove layout
     */
    ...
    /**
     * destory p_application and other resources and initialize it again
     */
    this.reset = function () {
    ...
    this._initialize = function () {
      ...
      var p_application = $.extend({}, this.options.p_application, $.summernote.plugins || {});

      // add and initialize p_application
      Object.keys(p_application).forEach(function (key) {
        self.module(key, p_application[key], true);
      });

      Object.keys(this.p_application).forEach(function (key) {
        self.initializeModule(key);
      });
    };

    this._destroy = function () {
      // destroy p_application with reversed order
      Object.keys(this.p_application).reverse().forEach(function (key) {
    ...
    this.initializeModule = function (key) {
      var module = this.p_application[key];
    ...
    this.module = function (key, ModuleClass, withoutIntialize) {
      if (arguments.length === 1) {
        return this.p_application[key];
      }

      this.p_application[key] = new ModuleClass(this);
    ...
    this.invoke = function () {
      ...
      var module = this.p_application[moduleName || 'editor'];
