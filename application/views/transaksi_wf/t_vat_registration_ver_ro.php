    ...
    <div class="col-xs-12">
        <div class="row">
            <div style="text-align: center;">
                ...
                <button class="btn btn-success" type="button" id="btn-edit" onclick="">CETAK FORMULIR</button>
                <button class="btn btn-success" type="button" id="btn-del" onclick="">CETAK SURAT PENOLAKAN</button>
                <button class="btn btn-danger" type="button" id="btn-del" onclick="submitform();">SUBMIT</button>
                <button class="btn btn-danger" type="button" id="btn-del" onclick="backform();">KEMBALI</button>
            </div>
        </div>
    </div>
</div>
