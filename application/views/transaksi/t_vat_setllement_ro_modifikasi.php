    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                {name: 'Hapus Transaksi',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        ...
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Hapus</a>';

                    }
                },

                {name: 'Ubah Ayat',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['t_customer_order_id'];
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_sptpd/pageCetak?t_cust_order_id='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Print</a>';

                    }
                },

                {name: 'Ubah Tanggal',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['t_customer_order_id'];
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_sptpd/pageCetak?t_cust_order_id='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Print</a>';
                ...
                {name: 'Ubah Total Trans.',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['t_customer_order_id'];
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_sptpd/pageCetak?t_cust_order_id='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Print</a>';
                ...
                {name: 'Cetak No. Bayar',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['payment_key'];
                        var url = '<?php echo base_url(); ?>'+'cetak_no_bayar/pageCetak?no_bayar='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'No. Bayar\',500,500);"><i class="fa fa-print"></i>Print</a>';

                    }
                },

                {name: 'Ubah Ketetapan',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['t_customer_order_id'];
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_sptpd/pageCetak?t_cust_order_id='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Print</a>';
                ...
                {name: 'Ubah Denda',width: 130, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        var val = rowObject['t_customer_order_id'];
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_sptpd/pageCetak?t_cust_order_id='+val;
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="PopupCenter(\''+url+'\',\'SKPDKB Jabatan\',500,500);"><i class="fa fa-list-alt"></i>Print</a>';
