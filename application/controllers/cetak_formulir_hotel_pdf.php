...
class cetak_formulir_hotel_pdf extends CI_Controller{
	...
	function pageCetak() {
		...
		*/
		...
		$pdf->Cell($per2+$per3, $this->height, "Setelah Formulir Pendaftaran ini diisi dan ditanda tangani,  harap diserahkan kembali Kepada Dinas Palayanan Pajak", "BR", 0, 'L');
		$pdf->Ln();
