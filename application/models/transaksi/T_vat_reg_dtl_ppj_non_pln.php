...
class T_vat_reg_dtl_ppj_non_pln extends Abstract_model {
    ...
    public $table           = "t_vat_reg_dtl_ppj_non_pln";
    public $pkey            = "t_vat_reg_dtl_ppj_npl_id";
    public $alias           = "a";

    public $fields          = array(
                                't_vat_reg_dtl_ppj_npl_id'            => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'ID Cust Order'),
