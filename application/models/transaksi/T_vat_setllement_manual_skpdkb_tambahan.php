...
class T_vat_setllement_manual_skpdkb_tambahan extends Abstract_model {
    ...
    function insertUpdate($cust_acc_id,$period,$npwd,$ms_start,$ms_end,$kamar,$tot,$p_vat_type_dtl_id,$p_vat_type_dtl_cls_id,$mode_denda){
        ...
        $query = $this->db->query($sql, array($cust_acc_id,$period,$npwd,$ms_start,$ms_end,$kamar,$tot,$p_vat_type_dtl_id,$p_vat_type_dtl_cls_id,$userdata['app_user_name'],$mode_denda));
