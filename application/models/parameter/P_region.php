...
class P_region extends Abstract_model {
    ...
    public $fields          = array(
                                ...
                                'region_name'           => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'Regional'),
                                'p_region_level_id'    => array('nullable' => false, 'type' => 'int', 'unique' => false, 'display' => 'ID Regional level'),
                                'p_business_area_id'    => array('nullable' => false, 'type' => 'int', 'unique' => false, 'display' => 'ID Bisnis'),
                                'parent_id'    => array('nullable' => false, 'type' => 'int', 'unique' => false, 'display' => 'ID Parent'),
                                'description'           => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'Deskripsi'),
                                'region_code'           => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'Kode Regional'),
                                'postal_code'           => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'Kode Postal'),
                                'nasional_code'           => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'Kode Nasional'),
